...
const Producto = () => {
    ...
    //Administrar y validad los votos
    const votarProducto = () => {
        if(!usuario ){
        ...
        //guardar el id del ususario que ha votado
    ...
    //identifica el creador del mensaje
    const esCreador = id => {
        if(creador.id == id ) {
            return true;
        }
    ...
    const agregarComentario = e => {
        ...
        //tomar copia de comentarios y agrgarlos al arreglo
